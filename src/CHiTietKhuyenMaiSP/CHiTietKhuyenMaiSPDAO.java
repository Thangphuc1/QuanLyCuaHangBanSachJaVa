...
public class CHiTietKhuyenMaiSPDAO {
    ...
    public boolean update(CHiTietKhuyenMaiSP ctkm) {
        ...
        String sql = "UPDATE ChiTietKhuyenMaiSP SET phamtramGG=? WHERE maKM=? AND maSP=?";
    ...
    public boolean delete(String maKM, String maSP) {
        ...
        String sql = "DELETE FROM ChiTietKhuyenMaiSP WHERE maKM=? AND maSP=?";
